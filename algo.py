...
def cal(cup, disc, eye):
    ...
    cal_s = cup_bound_s - disc_bound_s
    # print("S :", cal_s)
    ...
    cal_i = cup_bound_i - disc_bound_i
    # print("I : ", cal_i)
...
#     print(disc_bound_s)
    ...
    cal_t = cup_bound_t - disc_bound_t
    # print("T :", cal_t)
    ...
    cal_n = cup_bound_n - disc_bound_n
    # print("N : ", cal_n)

    #############################################################################################################

    cup_dias = [ver_cup_diameter, hor_cup_diameter] # [0][1] 
       
    if eye =='r' :
        cal_n, cal_t = swap(cal_n, cal_t)

    return list([cal_i, cal_s, cal_n, cal_t]), cup_dias
